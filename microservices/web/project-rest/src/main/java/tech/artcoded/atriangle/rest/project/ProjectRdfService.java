...
public class ProjectRdfService {
  ...
  @Inject
  public ProjectRdfService(ElasticRestFeignClient elasticRestFeignClient,
  ...
  public Optional<ProjectEvent> skosConversion(String projectId,
    ...
    MultipartFile xlsInput = FeignMultipartFile.builder()
                                               ...
                                               .bytes(projectFileService.downloadFile(projectId, xlsFileEvent.getId())
                                                                        .getBody()
                                                                        .getByteArray())
                                               .build();
  ...
  public String getCachedQueryTemplate(ProjectEvent project, String freemarkerTemplateFileId) {
    ...
    ResponseEntity<ByteArrayResource> freemarkerTemplate = projectFileService.downloadFile(project.getId(), freemarkerTemplateFileId);
