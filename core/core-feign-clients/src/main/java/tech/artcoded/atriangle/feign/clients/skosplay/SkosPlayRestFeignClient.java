package tech.artcoded.atriangle.feign.clients.skosplay;
...
@FeignClient(name = "SkosPlayRestPublicEndpoint",
             url = "${endpoint.skosplay.url}")
public interface SkosPlayRestFeignClient {
  /**
